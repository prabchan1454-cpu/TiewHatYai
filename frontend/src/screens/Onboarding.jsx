...
export default function Onboarding({ onDone }) {
  ...
  // Derive trip length + overlapping festival keys from the chosen window.
  const { days: tripDays, valid: datesValid, festivalKeys } = tripMeta(dateStart, dateEnd);
        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div>
              ...
              <TripDates start={dateStart} end={dateEnd} onStart={setDateStart} onEnd={setDateEnd} />
            </div>
          </div>
        )}
