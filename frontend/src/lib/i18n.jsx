...
export const STRINGS = {
  th: {
    ...
    "onboard.q.duration": "ระยะเวลาที่จะเที่ยว",
    ...
    "duration.half": "ครึ่งวัน",
    "duration.one": "หนึ่งวัน",
    "duration.multi": "หลายวัน",
