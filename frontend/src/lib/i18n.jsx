...
export const STRINGS = {
  th: {
    ...
    "rec.openNow": "เปิดอยู่",
    "rec.closedNow": "ปิดแล้ว",
    "rec.perNight": "/คืน",
    ...
    "tut.gameloop.title": "ลูปเกมหลัก",
    "tut.gameloop.desc": "ไปสถานที่จริง → ถ่ายรูปยืนยัน → รับ XP ขึ้นเลเวล วนซ้ำจนครบ 26 ดวง!",
    "tut.gameloop.step1": "ไปสถานที่",
    "tut.gameloop.step2": "ถ่ายรูปยืนยัน",
    "tut.gameloop.step3": "รับ XP & ดวง",
  ...
  en: {
    ...
    "rec.openNow": "Open now",
    "rec.closedNow": "Closed now",
    "rec.perNight": "/night",
    ...
    "tut.gameloop.title": "The Game Loop",
    "tut.gameloop.desc": "Visit a real place → snap a photo to verify → earn XP and level up. Repeat until you collect all 26 stamps!",
    "tut.gameloop.step1": "Visit the spot",
    "tut.gameloop.step2": "Take a photo",
    "tut.gameloop.step3": "Get XP & stamp",
    "tut.home.title": "Home",
