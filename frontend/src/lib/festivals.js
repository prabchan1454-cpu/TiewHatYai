...
const FESTIVALS = [
  ...
  { key: "chinesenewyear", emoji: "🧧", th: "ตรุษจีน", en: "Chinese New Year",
    theme: "ตรุษจีน ศาลเจ้า อาหารจีน ย่านคนไทยเชื้อสายจีนในหาดใหญ่", start: [2, 14], end: [2, 20] },
  ...
  { key: "veggie", emoji: "🥬", th: "เทศกาลกินเจ", en: "Vegetarian Festival",
    theme: "เทศกาลกินเจ อาหารเจ ศาลเจ้า ธงเหลือง วัฒนธรรมจีนในหาดใหญ่", start: [10, 10], end: [10, 20] },
